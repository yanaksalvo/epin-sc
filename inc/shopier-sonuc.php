	...
	<div class="row mt-10 mb-10">
		<div class="col-md-12">
			<ul class="adres_cubugu">
				...
				<li><a href="">Alışveriş Sonuç</a></li>
			</ul>
		</div>
	</div>
		...
		<?php
            if($_POST){
              ...
              $query = $db->prepare("SELECT * FROM siparis where siparis_key=:siparis_key AND kredi_karti_odendi=:kredi_karti_odendi LIMIT 1");
                    $gel = $query->execute(array(":siparis_key"=>$siparis_key,":kredi_karti_odendi"=>0));
              ...
              if($gel AND $_POST['status'] == 'success'){
                ...
                <div style="padding-bottom: 20px;font-size: 18px;color: #229f38;"><b>Siparişiniz başarı ile oluşturuldu.</b></div></<br>
                <div style="padding-bottom: 20px;font-size: 18px;"><b>Sipariş özetiniz email adresinize gönderilmiştir.</b></div><br>
                <div style="padding-bottom: 20px;font-size: 18px;"><b>Ürün Kodunuz: '.$kod['baslik'].'</b></div></center>';
